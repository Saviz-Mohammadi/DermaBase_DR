...
Item {
    ...
    signal updateClicked(name: string, newName: string, row: int);
    signal deleteClicked(imageName: string, row: int);
    signal viewClicked(row: int);
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            UFOButton {
                ...
                text: qsTr("مشاهده")
                icon.source: "qrc:/resources/icons/material/visibility.svg"

                onClicked: {
                    root.viewClicked(model.row);
                }
            }
            ...
            UFOButton {
                ...
                onClicked: {
                    root.deleteClicked(model.name, model.row);
                }
            }
        ...
        Item {
            ...
            ColumnLayout {
                ...
                UFOButton {
                    ...
                    onClicked: {
                        let newName = textFieldImageName.text;

                        root.updateClicked(model.name, newName, model.row);
                    }
                }
            }
        }
