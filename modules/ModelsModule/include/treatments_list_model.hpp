#ifndef TREATMENTSLISTMODEL_H
#define TREATMENTSLISTMODEL_H
...
class TreatmentsListModel : public QAbstractListModel
{
    Q_OBJECT
...
public:
    explicit TreatmentsListModel(QObject *parent = Q_NULLPTR, const QString& name = "No name");
    ~TreatmentsListModel();
