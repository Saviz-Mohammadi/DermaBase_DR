...
Item {
    ...
    signal editClicked(patientID: int);
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            UFOCheckBox {
                ...
                checked: model.hasVisited

                // WARNING (SAVIZ): I don't know why, but for some reason using 'changedChecked' signal causes a binding loop.
                onClicked: {
                    starredPatientsModel.requestUpdateVisitStatusOfStarredPatient(model.row, checkBoxVisited.checked);
                }
            }
            ...
            UFOButton {
                ...
                onClicked: {
                    root.editClicked(model.patientID);
                }
            }
